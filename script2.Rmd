...
# ggplot()+
#   geom_point(data= wirie0518_alti,
#              aes(datetime, elevmean, color = groundcover))+
#   geom_path(data = wirie0518_alti,
...
# speed_ground_join <- st_join(wirie0518_speed, posmo_gc, suffix = c("_speed", "_ground"))
# speed_ground_elev <- st_join(speed_ground_join, posmo_alti, suffix = c("", "_elev"))
