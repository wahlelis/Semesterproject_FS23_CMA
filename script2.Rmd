...
# 
# wirie0518_try <- wirie0518_try |> 
#   mutate(mtb_refined = segm_sum >= 3) # threshold for last segmentation
...
# wirie0518_try <- wirie0518_try |> 
#   filter(mtb_refined==TRUE) # select rows where the value is TRUE to select the moving segments
# 
...
```{r visualisation of average speed, dealing with NaN}
# explore what we just did
...
```{r valbirse visualisation of average speed, dealing with NaN }
# explore what we just did
