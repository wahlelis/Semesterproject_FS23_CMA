...
speed threshold
compute movement parameter speed for every fix and a profile of the movement parameter. (Dodge et al., 2009)
```{r}
...
Aurelia 20.06.2023
moving parameter (MP) profile for speed (Dodge et al., 2009)
```{r}
...
from the speed profile plot i suppose that the biking pattern starts around 9 o'clock and ends around half past one. 
to set a reasonable speed range or threshold, i want to figure out the average speed of a bike descent. i try to isolate the bike segments.    
```{r}
