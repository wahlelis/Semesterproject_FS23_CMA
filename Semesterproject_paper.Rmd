...
We chose the tour Lisa made on the 18th of May in Allmiried to define the characteristics of the biking movement pattern and tried to apply the criteria to the tours of XXX and YYY for verification. The Allmiried trajectory also included the car ride from Solothurn to the biking location and back. 
...
A first visualisation of transport modes of the data revealed that most of the mountainbiking part of the trajectory was labelled as "car" in the by the posmo app. 

For every fix of the trajectory we calculated the average speed within the window of four neighboring points, similar to the moving window method of Laube & Purves (2011). The euclidean distance to the two points before and the two points after the fix was calculated and divided by the time difference of the two points before and after the fix, respectively.

Movement parameter profile (Dodge et al., 2009). 

Segmentation based on static points, where it is assumed that the transport mode changed. the approach proposed by Laube & Purves (2011) was used. where the average speed resulted in non finite values dividing distance values by 0 time difference.

select the segments of biking by 

defining threshold: the values of the second and the third quartiles of the speed distribution were excluded from 
