...
- Which criteria can be used to characterize the movement pattern of downhill mountainbiking? 
...
The extraction of the mountainbiking parts of the trajectory was based on visual assessment of the movement parameter profile based on Dodge et al. (2009) for the average speed. 
...
MPP before and after segmentation
...
The elevation data was added to the dataset of the Wiriehorn 05-18 trajectory and the difference in elevation to the next point within a 40 second window in the direction of movement was calculated. If within this 40 second window the difference in altidude was negative, it is assumed to be downhill movement.

#### Combination of all criteria

For every point on the trajectory I displayed how many of the three criteria applied. Based on the count of matching criteria, I isolated new segments that represent downhill mountainbiking according to the following conditions: 
